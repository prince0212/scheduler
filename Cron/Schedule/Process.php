...
class Process
{
    ...
    public function execute()
    {
        ...
        $searchScriteria = $this->searchCriteriaBuilder
            ...
            ->addFilter(ScheduleInterface::DATE_FROM, $this->date->gmtDate(), 'lteq')
            ->addFilter(ScheduleInterface::STATUS, ScheduleInterface::STATUS_SCHEDULED);
