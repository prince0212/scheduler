...
namespace Magetrend\Scheduler\Block\Adminhtml\Config\System\Config;
...
{
    const MODULE_NAMESPACE = 'Magetrend_Scheduler';

    const CONFIG_NAMESPACE = 'scheduler';

    const XML_PATH_GENERAL = 'scheduler/general/is_active';
