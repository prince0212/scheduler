...
/**
 * Catalog conditions tab block class
 */
class Condition extends Generic implements TabInterface
{
     ...
     */
    public function addTabToForm($model, $fieldsetId = 'conditions_fieldset', $formName = 'catalog_rule_form')
    {
        /** @var \Magento\Framework\Data\Form $form */
        ...
        $newChildUrl = $this->getUrl(
            'scheduler/schedule/newConditionHtml/form/' . $conditionsFieldSetId,
        ...
        $fieldset = $form->addFieldset(
            $fieldsetId,
            ['legend' => __('Products by Conditions')]
