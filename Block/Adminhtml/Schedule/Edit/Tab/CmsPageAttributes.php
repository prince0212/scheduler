...
/**
 *  Cms page attribute tab block class
 */
class CmsPageAttributes extends Generic implements TabInterface
{
    /**
    ...
    {
        $fieldset2 = $form->addFieldset('status_fieldset', ['legend' => __('CMS Page Status')]);
        $fieldset2->addField(
            ScheduleInterface::CMS_PAGE_STATUS,
            'select',
            [
                'name' => 'schedule['.ScheduleInterface::CMS_PAGE_STATUS.']',
        ...
        $fieldset2->addField(
            ...
            'select',
            [
                'name' => 'schedule['.ScheduleInterface::CMS_PAGE_NEW_STATUS.']',
                'label' => __('New Status'),
                'title' => __('New Status'),
                'value' => 0,
    ...
    public function addStatusDependencies($dependence, $htmlIdPrefix)
    {
        $dependence->addFieldMap(
            $htmlIdPrefix.ScheduleInterface::CMS_PAGE_STATUS,
            ScheduleInterface::CMS_PAGE_STATUS
        )->addFieldMap(
            $htmlIdPrefix.ScheduleInterface::CMS_PAGE_NEW_STATUS,
            ScheduleInterface::CMS_PAGE_NEW_STATUS
        )->addFieldDependence(
            ScheduleInterface::CMS_PAGE_NEW_STATUS,
            ScheduleInterface::CMS_PAGE_STATUS,
